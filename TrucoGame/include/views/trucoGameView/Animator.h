...
namespace TrucoGame {
    namespace View {
        ...
        public:
            ...
            static void protectMoveAndRotateSpriteTo(CardView& cardView, const sf::Vector2f& destinationPosition, float finalRotation, float speed);
            static void moveAndRotateSpriteTo(Sprite& sprite, const sf::Vector2f& destinationPosition, float finalRotation, float speed);
            ...
            static void moveAndFlipCardTurnedFaceUpTo(Sprite& sprite, Texture* texture, const std::string& newTexturePath, const sf::Vector2f& destinationPosition, float speed, const float cardScale);
